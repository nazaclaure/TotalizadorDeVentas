...
describe("Totalizador de Ventas", () => {
  ...
  it("deberia cobrar $3.5 por unidad de costo de envio si el peso volumetrico es entre 11 y 20", () => {
    const resultado = totalizador(4, 10, "CA", "Varios", 15);
    expect(resultado.costoEnvio).toEqual(14);
  });

  it("deberia cobrar $5 por unidad de costo de envio si el peso volumetrico es entre 21 y 40", () => {
  ...
  it("deberia cobrar $6.5 por unidad de costo de envio si el peso volumetrico es entre 81 y 100", () => {
    const resultado = totalizador(1, 10, "CA", "Varios", 90);
    expect(resultado.costoEnvio).toEqual(6.5);
  });

  it("deberia cobrar $8 por unidad de costo de envio si el peso volumetrico es entre 101 y 200", () => {
    const resultado = totalizador(2, 15, "CA", "Varios", 150);
    expect(resultado.costoEnvio).toEqual(16);
  });

  it("deberia cobrar $9 por unidad de costo de envio si el peso volumetrico es mayor a 200", () => {
